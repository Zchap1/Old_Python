#!/bin/env_python
# python keylogger is just another script created in python 
# & it uses Xlib and you most need connection to monitor the state of the keyboard.
...
# Holding the keyboard state.  32 bytes, with each
...
if __name__ == "__main__":
    ...
    def print_keys(t, modfiers, keys):
